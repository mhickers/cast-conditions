...
const TOWNS = [
  ...
  // --- Added batch: next 50 higher-volume US fisheries (apostrophe-free water) ---
  { name: 'Kerr Lake, NC', lat: 36.6000, lon: -78.3000, type: 'inland', water: 'the main-lake points, creek arms, and flats' },
  { name: 'Pickwick Lake, AL', lat: 34.9800, lon: -88.1500, type: 'inland', water: 'the current breaks, ledges, and tailrace' },
  { name: 'Weiss Lake, AL', lat: 34.2000, lon: -85.6000, type: 'inland', water: 'the flats, river channel, and grass edges' },
  { name: 'Quabbin Reservoir, MA', lat: 42.3500, lon: -72.3500, type: 'inland', water: 'the clear open water, points, and coves' },
  { name: 'Lake Mohave, AZ', lat: 35.3000, lon: -114.6000, type: 'inland', water: 'the cold clear water, coves, and the river channel' },
  { name: 'Canyon Ferry Lake, MT', lat: 46.5500, lon: -111.7000, type: 'inland', water: 'the flats, weed edges, and open water' },
  { name: 'Lake Coeur d Alene, ID', lat: 47.6000, lon: -116.7500, type: 'inland', water: 'the chain lakes, bays, and river mouths' },
  { name: 'Willard Bay, UT', lat: 41.3700, lon: -112.0600, type: 'inland', water: 'the open flats, dikes, and inlet areas' },
  { name: 'Elephant Butte Lake, NM', lat: 33.1500, lon: -107.2000, type: 'inland', water: 'the coves, points, and main-lake flats' },
  { name: 'White River, AR', lat: 36.3500, lon: -92.5500, type: 'inland', water: 'the tailwater trout runs below Bull Shoals Dam' },
  { name: 'Salmon River, NY', lat: 43.5500, lon: -76.1300, type: 'inland', water: 'the steelhead and salmon runs around Pulaski' },
  { name: 'Muskegon River, MI', lat: 43.5500, lon: -85.9500, type: 'inland', water: 'the salmon, steelhead, and walleye runs' },
  { name: 'Hilton Head, SC', lat: 32.1600, lon: -80.7500, type: 'coastal', water: 'the sounds, tidal creeks, and beachfront' },
  { name: 'Cherokee Lake, TN', lat: 36.2500, lon: -83.4500, type: 'inland', water: 'the flats, points, and river channel' },
  { name: 'Douglas Lake, TN', lat: 36.0500, lon: -83.3500, type: 'inland', water: 'the flats, creek arms, and standing timber' },
  { name: 'Reelfoot Lake, TN', lat: 36.3500, lon: -89.3500, type: 'inland', water: 'the cypress stumps, ditches, and open water' },
  { name: 'Little Red River, AR', lat: 35.5500, lon: -91.7500, type: 'inland', water: 'the trophy trout tailwater below Greers Ferry Dam' },
  { name: 'Stockton Lake, MO', lat: 37.6500, lon: -93.7500, type: 'inland', water: 'the points, flats, and clear open water' },
  { name: 'Eufaula Lake, OK', lat: 35.3000, lon: -95.6000, type: 'inland', water: 'the flats, creek arms, and points' },
  { name: 'Broken Bow Lake, OK', lat: 34.1500, lon: -94.6800, type: 'inland', water: 'the clear coves, bluffs, and timber' },
  { name: 'Tenkiller Lake, OK', lat: 35.6000, lon: -95.0500, type: 'inland', water: 'the clear points, coves, and river channel' },
  { name: 'Canyon Lake, TX', lat: 29.8700, lon: -98.2600, type: 'inland', water: 'the clear points, coves, and main-lake structure' },
  { name: 'Possum Kingdom Lake, TX', lat: 32.8700, lon: -98.4300, type: 'inland', water: 'the bluffs, points, and clear coves' },
  { name: 'North Platte River, WY', lat: 42.3500, lon: -106.8500, type: 'inland', water: 'the trophy trout tailwater around Grey Reef' },
  { name: 'Jackson Lake, WY', lat: 43.8500, lon: -110.6000, type: 'inland', water: 'the deep cold water, points, and inlets' },
  { name: 'Yellowstone Lake, WY', lat: 44.4500, lon: -110.3700, type: 'inland', water: 'the drop-offs, shoals, and shoreline' },
  { name: 'Hebgen Lake, MT', lat: 44.8500, lon: -111.3500, type: 'inland', water: 'the weed edges, gulpers, and inlet flats' },
  { name: 'Bighorn Lake, MT', lat: 45.1000, lon: -108.1500, type: 'inland', water: 'the canyon walls, coves, and the river inlet' },
  { name: 'Dworshak Reservoir, ID', lat: 46.5800, lon: -116.3000, type: 'inland', water: 'the steep arms, points, and creek mouths' },
  { name: 'Lake Cascade, ID', lat: 44.5500, lon: -116.0500, type: 'inland', water: 'the flats, drop-offs, and shoreline structure' },
  { name: 'Priest Lake, ID', lat: 48.5500, lon: -116.8500, type: 'inland', water: 'the deep clear water, drop-offs, and thorofare' },
  { name: 'Jordanelle Reservoir, UT', lat: 40.6000, lon: -111.4200, type: 'inland', water: 'the points, inlets, and open water' },
  { name: 'Deer Creek Reservoir, UT', lat: 40.4200, lon: -111.5000, type: 'inland', water: 'the points, inlets, and the dam area' },
  { name: 'Pineview Reservoir, UT', lat: 41.2500, lon: -111.8000, type: 'inland', water: 'the arms, weed edges, and inlet flats' },
  { name: 'Ute Lake, NM', lat: 35.3500, lon: -103.4500, type: 'inland', water: 'the long arms, points, and rocky flats' },
  { name: 'Dillon Reservoir, CO', lat: 39.6000, lon: -106.0500, type: 'inland', water: 'the coves, points, and inlet areas' },
  { name: 'Eleven Mile Reservoir, CO', lat: 38.9200, lon: -105.5000, type: 'inland', water: 'the flats, points, and open water' },
  { name: 'Pueblo Reservoir, CO', lat: 38.2600, lon: -104.7200, type: 'inland', water: 'the coves, points, and main-lake flats' },
  { name: 'Red Lake, MN', lat: 48.0000, lon: -95.0000, type: 'inland', water: 'the shoreline breaks and open flats' },
  { name: 'Gull Lake, MN', lat: 46.4200, lon: -94.3500, type: 'inland', water: 'the bars, cabbage, and drop-offs' },
  { name: 'Houghton Lake, MI', lat: 44.3200, lon: -84.7500, type: 'inland', water: 'the weed flats, breaks, and open water' },
  { name: 'Grand Traverse Bay, MI', lat: 44.8500, lon: -85.5000, type: 'inland', water: 'the drop-offs, reefs, and river mouths' },
  { name: 'Keuka Lake, NY', lat: 42.5500, lon: -77.1000, type: 'inland', water: 'the drop-offs, weed lines, and inlet flats' },
  { name: 'Candlewood Lake, CT', lat: 41.5000, lon: -73.4500, type: 'inland', water: 'the drop-offs, coves, and dock edges' },
  { name: 'Farmington River, CT', lat: 41.8500, lon: -72.9500, type: 'inland', water: 'the tailwater and freestone trout runs' },
  { name: 'Rangeley Lake, ME', lat: 44.9500, lon: -70.7000, type: 'inland', water: 'the cold clear water, inlets, and drop-offs' },
  { name: 'Klamath River, CA', lat: 41.5200, lon: -123.9800, type: 'inland', water: 'the salmon and steelhead runs and riffles' },
  { name: 'Feather River, CA', lat: 39.1000, lon: -121.6200, type: 'inland', water: 'the salmon and steelhead runs below the dam' },
  { name: 'American River, CA', lat: 38.6300, lon: -121.3000, type: 'inland', water: 'the salmon and steelhead runs and gravel bars' },
  { name: 'Russian River, CA', lat: 38.4500, lon: -123.1000, type: 'inland', water: 'the steelhead runs, riffles, and estuary' },
];
